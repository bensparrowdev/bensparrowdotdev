export default function SideDrawer({ drawerOpen, setDrawerOpen }) {
  return (
    <div className="relative z-20">
      ...
      <aside
        className={`fixed right-0 top-0 h-full w-full overflow-auto sm:w-[36rem] p-8 bg-secondary dark:bg-secondary_dark transition-transform duration-300 ${
          drawerOpen ? "translate-x-0" : "translate-x-full"
        }`}
      >
        <div className="flex justify-between font-light pb-4 mb-8 border-b">
          <div
